<p align="center">
  <img src="./assets/LinkedIn banner.jpg" alt="profile" width="100%">
</p>
...
REST APIs, authentication, role-based access control, database design, layered architecture, and maintainable business logic using Python frameworks.
...
End-to-end feature delivery, requirements translation, user stories, sprint planning, workflow design, and user-focused decision-making.
...
NLP pipelines, semantic matching, vector embeddings, RAG, machine learning, speech processing, and computer-vision-assisted evaluation.
